        ...
        <nav
            ...
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <ActiveLink href="/" className="flex items-center" onHandleMobileMenu={() => setIsShowMobileMenu(false)}>
                    ...
                    <span
                        className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">RoCommerce</span>
                </ActiveLink>
                ...
                <div className="flex md:order-2">
                    ...
                    <button onClick={onHandleMobileMenu} type="button"
                ...
                <div
                    className={`items-center justify-between ${isShowMobileMenu ? '' : 'hidden'} w-full md:flex md:w-auto md:order-1`}>

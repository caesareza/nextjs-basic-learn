  ...
  return (
    ...
    <section>
      {product.length > 0 ? (
        ...
        [0,1,2,3,4].map((index) => (
          <div key={index} role="status" class="mb-5 p-3 border border-gray-200 rounded-lg shadow space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
            <div class="flex items-center justify-center w-full h-64 bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
